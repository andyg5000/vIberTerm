# Playwright Testing Best Practices for VibeTmux

## Overview

This guide documents best practices for writing reliable, non-flaky Playwright tests for VibeTmux, based on official Playwright documentation and community best practices.
...
test.beforeEach(async ({ page }) => {
  ...
  await page.goto('/');
  await page.waitForSelector('vibetmux-app', { state: 'attached' });
});
```
